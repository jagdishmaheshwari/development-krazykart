            ...
            <div class="modal-body">
                ...
                <form id="addCategoryForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="c_description" name="description" style="height:70px !important"
                            required>
                    </div>
                    <div class="mb-3">
                        <label for="c_keywords" class="form-label">Keywords:</label>
                        <input type="text" class="form-control" id="c_keywords" name="description" style="height:70px !important"
                            required>
                    </div>
                    <div>
                        <button type="button" class="btn btn-primary float-end" onclick="addCategory()">Add Category</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="editCategoryForm">
                    ...
                    <div>
                        <button type="button" class="btn btn-primary float-end" onclick="updateCategory()">Update This
                            Category</button>
                    </div>
                </form>
            </div>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.status === 'success') {
                            swal({ icon: "success", title: "Category Deleted Successfully!" }).then(function () {
                                window.location.reload();
                            });
                        } else if (response === 'data') {
                            swal({ icon: "info", title: "There are some products associated with this category!" })
                        } else {
                            swal({ icon: "error", title: "Something went wrong. Please try again later!" })
                        }
                    },
                    error: function () {
